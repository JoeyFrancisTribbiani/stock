...
public class SkuPropertyValues {
    ...
    public void setSkuPropertyValueTips(String skuPropertyValueTips) {
     ...
     public String getSkuPropertyValueTips() {
         return skuPropertyValueTips;
     }

    public void setSkuPropertyValueShowOrder(int skuPropertyValueShowOrder) {
         this.skuPropertyValueShowOrder = skuPropertyValueShowOrder;
     }
     public int getSkuPropertyValueShowOrder() {
         return skuPropertyValueShowOrder;
     }
    ...
    public void setPropertyValueIdLong(int propertyValueIdLong) {
         this.propertyValueIdLong = propertyValueIdLong;
     }
     public int getPropertyValueIdLong() {
         return propertyValueIdLong;
     }
    ...
    public void setSkuPropertyImageSummPath(String skuPropertyImageSummPath) {
     ...
     public String getSkuPropertyImageSummPath() {
         return skuPropertyImageSummPath;
     }
