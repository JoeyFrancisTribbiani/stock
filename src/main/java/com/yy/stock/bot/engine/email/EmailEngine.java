...
public class EmailEngine {
    ...
    public static String getHtmlTagContent(String htmlSource, String cssSelector) {
        Document doc = Jsoup.parse(htmlSource);
        Element codeBr = doc.select(cssSelector).first();
        return codeBr.text();
    }
     ...
     * 用于收取Gmail邮件
     */
    public String reciveIMAPmail(String username, String password, SearchTerm searchTerm) throws MessagingException, IOException {
        ...
        StringBuffer content = new StringBuffer(6666);
