...
public abstract class AmazonStockEngine extends StockEngine {
    protected PlatformService platformService;
    protected StockStatusService stockStatusService;
//    protected AmazonBrCoreEngine coreEngine;
//    protected AmazonLoginEngine loginEngine;
//    protected AmazonBrAddressEngine addressUnit;

    public AmazonStockEngine() {
    ...
    private String generPlatformOrderPageUrl(String platformOrderId) {
        return "https://www.Amazon.com/p/order/detail.html?orderId=" + platformOrderId;
    }
