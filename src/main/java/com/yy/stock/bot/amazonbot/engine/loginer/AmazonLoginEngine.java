package com.yy.stock.bot.amazonbot.engine.loginer;
...
@Slf4j
public class AmazonLoginEngine extends LoginEngine {
    @Override
...
//        driverEngine.getExecutor().switchToDefaultContent();
    ...
    public void solveChickenCaptcha() throws InterruptedException {
        var ulr = "https://passport.Amazon.com/";
//        var testUrl = "https://passport.Amazon.com/ac/pc_r_open.htm?fromSite=13";
